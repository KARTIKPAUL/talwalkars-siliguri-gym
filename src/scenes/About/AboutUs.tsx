        ...
        <div className="w-full max-w-7xl">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-yellow-400 drop-shadow-lg">
              About Talwalkars siliguri Fitness Gym
            </h1>
            <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-300">
              Welcome to Talwalkars siliguri Fitness Gym – The Premier Fitness Destination in Siliguri! We offer a 
          ...
          >
            ...
            <div className="space-y-4 text-lg text-gray-300">
              <p><MapPin className="inline mr-2" />  4th floor, Metro Heights, Sevoke Road, Opp. Club Town, Siliguri, India</p>
              <p><Phone className="inline mr-2" /> 091440 16366</p>
              <p><Mail className="inline mr-2" />  talwalkarslg@gmail.com</p>
            </div>
          </motion.div>
