  ...
  return (
    <div className='app'>
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
        <h1 className="text-3xl font-bold mb-4">Terms and Conditions for Talwalkars siliguri Gym</h1>
        <p className="text-gray-700">Effective Date: 25/02/2025</p>
        
        <section className="mt-4">
          <h2 className="text-xl font-semibold">1. Introduction</h2>
          <p className="text-gray-700">Welcome to Talwalkars siliguri Gym. By accessing or using our services, you agree to comply with and be bound by these Terms and Conditions.</p>
        </section>
        ...
        <section className="mt-4">
          ...
          <p className="text-gray-700">Talwalkars siliguri Gym is not responsible for injuries, lost items, or accidents that occur within the premises.</p>
        </section>
        ...
        <section className="mt-4">
          ...
          <p className="text-gray-700 font-semibold">Talwalkars siliguri Gym</p>
          <p className="text-gray-700">4th floor, Metro Heights, Sevoke Road, Opp. Club Town, Siliguri, India</p>
          <p className="text-gray-700">Email: <strong>talwalkarslg@gmail.com</strong></p>
          <p className="text-gray-700">Phone: <strong>091440 16366</strong></p>
        </section>
